        ...
        <div class="col-lg">
          <div class="p-5">
            <div class="text-center">
              <h1 class="h4 text-gray-900 mb-4">Create  Account Petugas</h1>
            </div>
            <form class="user" method="post" action="<?= base_url('auth/registration') ?>">
              ...
              <div class="form-group">
                <select class="custom-select" name="damkar_id">
                  <option selected disabled>Select Kantor</option>
                  <?php foreach ($alloffice->result() as $office) {  ?>
                    <option value="<?= $office->damkar_id; ?> "><?= $office->keterangan; ?> </option>
                  <?php } ?>
                </select>
              </div>
            ...
            <!-- <div class="text-center">
              ...
              <div class="text-center">
                <a class="small" href="<?= base_url('administrator'); ?>">Already have an account? Login!</a>
              </div> -->
          </div>
        </div>
      </div>
